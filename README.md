...
백엔드입니다. Gemini는 사용자의 비정형 문장과 장소 근접 그룹을 구조화하고, 시간 교집합·장소 그룹·후보
...
4. 입력이 마감되면 Gemini가 자연어와 참여자 전체의 장소 근접 호환 그룹을 구조화합니다.
...
- **AI / Place:** Gemini 3.8 Flash, Google GenAI SDK
  - 자연어 조건과 방 전체 명시 장소의 근접 호환 그룹 구조화
