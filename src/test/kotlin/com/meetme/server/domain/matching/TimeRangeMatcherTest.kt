...
class TimeRangeMatcherTest {
    ...
    fun `모임 소요 시간보다 짧은 연속 구간은 제거한다`() {
        ...
        assertEquals(
            listOf(range("2026-09-21T01:30:00Z", "2026-09-21T03:00:00Z")),
            calculate(naturalWindows = listOf(natural), blocked = blocked, durationMinutes = 60),
        )
    }
    ...
    private fun calculate(
        ...
        TimeRangeMatcher.calculateAvailability(
            ...
            duration = MeetingDuration.ofMinutes(durationMinutes),
        )
