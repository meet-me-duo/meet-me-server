...
class TimeModelsTest {
    @Test
    fun `모임 소요 시간과 좌표의 유효 범위를 검증한다`() {
        assertEquals(Duration.ofMinutes(90), MeetingDuration.ofMinutes(90).value)
        assertThrows<IllegalArgumentException> { MeetingDuration.ofMinutes(0) }
