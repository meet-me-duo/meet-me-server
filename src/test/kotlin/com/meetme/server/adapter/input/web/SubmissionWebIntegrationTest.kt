        ...
        mockMvc
            .perform(
                get("/api/rooms/{inviteCode}/submission", room.inviteCode)
                    .cookie(Cookie(RoomLifecycleController.GUEST_COOKIE, room.credential)),
            ).andExpect(status().isOk)
            .andExpect(jsonPath("$.revision").value(2))
        ...
        mockMvc
            .perform(
                get("/api/rooms/{inviteCode}/submission", host.inviteCode)
                    .cookie(Cookie(RoomLifecycleController.GUEST_COOKIE, member.credential)),
            ...
            mockMvc
                .perform(
                    post("/api/rooms/{inviteCode}/analysis/retry", host.inviteCode)
                        ...
                        .cookie(Cookie(RoomLifecycleController.GUEST_COOKIE, host.credential)),
            ...
            mockMvc
                .perform(
                    post("/api/rooms")
                        ...
                        .content(
                            """
                            {"purpose":"제출 테스트","duration_minutes":60,"meeting_mode":"EITHER",
