        ...
        mockMvc
            .perform(
                get("/api/rooms/{inviteCode}/candidates", INVITE_CODE)
                    .cookie(Cookie(com.meetme.server.shared.adapter.input.web.GuestCookie.NAME, MEMBER_CREDENTIAL))
        ...
        mockMvc
            .perform(
                get("/api/rooms/{inviteCode}/candidates/unapplied-inputs", INVITE_CODE)
                    .cookie(Cookie(com.meetme.server.shared.adapter.input.web.GuestCookie.NAME, HOST_CREDENTIAL)),
            ).andExpect(status().isOk)
