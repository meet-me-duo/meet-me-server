...
import com.meetme.server.coordination.application.port.output.NormalizedPlaceSnapshot
...
class KakaoLocalPlaceAdapterTest {
    ...
    fun `keeps Kakao response types outside the outbound port contract`() {
        ...
        assertTrue(NormalizedPlaceSnapshot::class.java.packageName.startsWith("com.meetme.server.coordination.application.port.output"))
    }
