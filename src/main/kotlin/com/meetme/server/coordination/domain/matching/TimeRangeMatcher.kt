...
import com.meetme.server.shared.domain.time.resolveEndOfDayBoundary
import com.meetme.server.shared.domain.time.resolveOn
import com.meetme.server.shared.domain.time.resolveStartOfDay
...
object TimeRangeMatcher {
    ...
    fun calculateAvailability(
        ...
        val availableConditions =
            naturalWindows.filter { it.polarity == com.meetme.server.submission.domain.TimePolarity.AVAILABLE }
        ...
        val naturalUnavailable =
            expandNaturalWindows(
                naturalWindows.filter { it.polarity == com.meetme.server.submission.domain.TimePolarity.UNAVAILABLE },
                searchRange,
                zone,
            )
