...
import com.meetme.server.domain.matching.AllowedCircle
import com.meetme.server.domain.matching.DeterministicCandidateMatcher
import com.meetme.server.domain.matching.ParticipantAllowedRegion
import com.meetme.server.domain.matching.ParticipantMatchInput
...
class MatchingProcessor(
    ...
    fun process(batchId: SubmissionBatchId) {
            ...
            try {
                submissions.map { submission ->
                    ...
                    ParticipantMatchInput(
                        ...
                        availableTimes =
                            com.meetme.server.domain.matching.TimeRangeMatcher.calculateAvailability(
        ...
        val generated = DeterministicCandidateMatcher.generate(room.mode, room.duration, inputs)
    ...
    private fun PlaceNormalizationResult.toSnapshot(
        ...
        submissionVersionId: com.meetme.server.domain.common.SubmissionVersionId,
        index: Int,
...
class MatchingProcessingPersistenceService(
    private val roomRepository: com.meetme.server.application.port.output.MeetingRoomRepository,
    private val runRepository: CoordinationRunRepository,
    private val normalizedPlaceRepository: NormalizedPlaceRepository,
) {
    fun room(id: com.meetme.server.domain.common.MeetingRoomId) =
